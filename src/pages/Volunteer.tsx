        ...
        <div className="bg-slate-50 min-h-screen py-20 font-sans text-slate-900">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 font-serif mb-6">Volunteering & Service</h1>
                ...
                <div className="grid gap-12">
                    ...
                    <div className="bg-white rounded-2xl p-8 md:p-10 shadow-sm border border-slate-200">
                        <div className="flex items-center mb-8">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900">Conference Service</h2>
                        </div>
                        ...
                        <div className="space-y-8 pl-4 border-l-2 border-indigo-50">
                            <div className="relative pl-8">
                                ...
                                <h3 className="text-xl font-bold text-slate-900">Web Chair, ACM Symposium on Spatial User Interaction (SUI 2025)</h3>
                                <p className="text-sm text-slate-500 font-mono mb-2">Dec 2025 - Present</p>
                            ...
                            <div className="relative pl-8">
                                <div className="absolute -left-[9px] top-2 w-4 h-4 rounded-full bg-indigo-500 border-4 border-indigo-100"></div>
                                <h3 className="text-xl font-bold text-slate-900">Web Chair, ACM VRST 2025</h3>
                                <p className="text-sm text-slate-500 font-mono mb-2">Dec 2025 - Present</p>
                                <p className="text-slate-600">
                    ...
                    <div className="bg-white rounded-2xl p-8 md:p-10 shadow-sm border border-slate-200">
                        <div className="flex items-center mb-8">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900">Global Teaching & Mentorship</h2>
                        </div>

                        <div className="prose prose-lg text-slate-600">
                            <h3 className="text-lg font-bold text-slate-900">Volunteer Instructor, University of the People</h3>
                            <p className="text-sm text-slate-500 font-mono mb-4">Apr 2025 - Present</p>
                            <p>
                    ...
                    <div className="bg-white rounded-2xl p-8 md:p-10 shadow-sm border border-slate-200">
                        <div className="flex items-center mb-8">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900">Community & Disaster Response</h2>
                        </div>

                        <div className="prose prose-lg text-slate-600">
                            <h3 className="text-lg font-bold text-slate-900">Nepal Earthquake Recovery (2015)</h3>
                            <p>
